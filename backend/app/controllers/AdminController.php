...
class AdminController extends Controller
{
    ...
    public function deleteCategory(): void
    {
        ...
        try {
            ...
            // Kiểm tra ràng buộc
            $postCount = $this->categoryModel->countPostsByCategoryId($id);
    ...
    public function categories(): void
    {
        ...
        $categories = $this->categoryModel->getAllPaginated($search, $sort, $limit, $offset);
        $totalCategories = $this->categoryModel->countAll($search);
