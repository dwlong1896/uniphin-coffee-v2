...
<head>
    ...
    <link rel="stylesheet" href="<?php echo htmlspecialchars($assetUrl('css/auth/signup.css'), ENT_QUOTES, 'UTF-8'); ?>">
</head>
<body>
    ...
    <div class="signup-wrapper">
        ...
        <div class="signup-card">
            <form action="#" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="password-input-wrapper">
                        ...
                        <button type="button" class="eye-btn" data-target="password" aria-label="Hiển thị mật khẩu">👁</button>
                    </div>
                </div>
            ...
            <div class="signin-redirect">
                    Bạn đã có tài khoản? <a href="<?php echo htmlspecialchars(($publicBase === '' ? '' : $publicBase) . '/login', ENT_QUOTES, 'UTF-8'); ?>">Đăng nhập</a>
            </div>
        </div>
    </div>
</div>
